...
WebStorm、PhpStorm、Rider、CLion、RubyMine、GoLand、Aqua、Android Studio）。特定于 IDE 的插件放置在“语言
specific“部分。另请记住，所有 Jetbrains IDE 都提供了出色的开箱即用的编程支持
languages 本身和主要框架，它们默认处于启用状态，因此将它们包含在此中没有意义
列表。
...
* [Window Resizer](https://plugins.jetbrains.com/plugin/18045-window-resizer)
    * 调整 IDE 窗口的大小。在 Messenger 中的屏幕共享期间很有用。
...
* [String Manipulation](https://plugins.jetbrains.com/plugin/2162-string-manipulation)
    * 用于作纯字符串的各种工具。 例如，排序、筛选等。您可以为任何作添加快捷方式，最有用的是 快捷方式 在情况之间切换。
...
* [Json Helper](https://plugins.jetbrains.com/plugin/13873-json-helper)
    * 用于作 JSON 的各种工具。例如，JSON 路径搜索、escape/unescape、uglify/prettify 等。
...
* [GitToolBox](https://plugins.jetbrains.com/plugin/7499-gittoolbox)
    * 通过启用自动完成、显示各种附加信息（如提前提交的数量等）、分支清理、自动获取和各种其他功能来改进 git 的工作。
...
* [Qodo Gen](https://plugins.jetbrains.com/plugin/21206-qodo-gen)
    * 启用 Qodo（以前的 CodiumAI）与 IDE 的集成。
...
* [Grazie Pro](https://plugins.jetbrains.com/plugin/16136-grazie-pro)
    * Jetbrains 用于语法和拼写检查的付费插件。它还具有八种语言的翻译功能。
